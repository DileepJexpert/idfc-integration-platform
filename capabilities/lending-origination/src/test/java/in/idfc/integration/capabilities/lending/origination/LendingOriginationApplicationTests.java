 ...
 */
class LendingOriginationApplicationTests {
    @Test
    void stubModuleIsPresent() {
        assertThat(LendingOriginationApplication.class.getPackageName()).isEqualTo("in.idfc.integration.capabilities.lending.origination");
    }
}
