...
// device-financing capability — brand-as-config: ONE capability, per-brand
...
description = "device-financing — brand-as-config capability (real HTTP; vendor mocked in dev)"
