package in.idfc.integration.capabilities.payments;
...
class PaymentsApplicationTests {
    ...
    void stubModuleIsPresent() {
        assertThat(PaymentsApplication.class.getPackageName()).isEqualTo("in.idfc.integration.capabilities.payments");
    }
}
