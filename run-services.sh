...
# infra over host ports (Kafka :29092, Aerospike :3000, vendor mocks :19101-05).
#
...
SERVICES=(
  ...
  "verification|capabilities/verification|8102"
  "communications|capabilities/communications|8101"
  "mandate|capabilities/mandate|8098"
