...
$Services = @(
    ...
    @{ name = 'verification';        module = 'capabilities/verification';          port = 8102 }
    @{ name = 'communications';      module = 'capabilities/communications';        port = 8101 }
    @{ name = 'mandate';             module = 'capabilities/mandate';               port = 8098 }
